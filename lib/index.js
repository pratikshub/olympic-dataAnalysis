...
const medalWonIndia = (0, _olympic.medalWonByIndia)(_events.default, 'India'); // console.log(olympicHostedPerCity)

console.log(medalWonbyCountry); // console.log(participations)
